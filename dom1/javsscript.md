...
### code
```
   document.querySelector(".contact-us .customer-support .one-tel-number").innerText="+91 6366256689"
```
...
### Tasks
 ...
 ### code
 ```
 document.querySelectorAll("#SIvCob a").forEach((e,i) =>{if(i%2!=0){document.querySelectorAll("#SIvCob a")[i].removeChild()}})
 ```
### Output
...
### code
```
document.querySelector(".section-title_title__VEDfK").innerHTML="Start with the Scratch"
